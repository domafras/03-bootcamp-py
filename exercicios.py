...
quantidade = 10  # Exemplo de valor -> input("Insira a quantidade")
preço = 20  # Exemplo de valor -> input("Insira o preço")
...
idade = 10 # Exemplo de valor -> input
email = "usuario@exemplo.com" # Exemplo de valor -> input
...
dados = []
while True:
    entrada = input("Digite algo (ou 'sair' para terminar): ").strip()
...
pagina_atual = 1
paginas_totais = 3  # Simulação, na prática, isso viria da API
...
while tentativa <= tentativas_maximas:
    ...
    # Aqui iria o código para transofrmar conexão em True
    if conexao == True:
